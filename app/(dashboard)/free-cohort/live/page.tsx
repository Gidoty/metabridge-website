...
export const metadata: Metadata = { title: 'Free Cohort — Live Session' }

export default async function FreeCohortLivePage() {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-gray-400 text-sm mb-6 max-w-md">
          The facilitator has not started a broadcast yet. Check back soon or wait for your cohort schedule.
        </p>
  ...
  try {
    const room = await getOrCreateRoom('metabridge-free-cohort', false)
    roomUrl = room.url
    token = await createMeetingToken('metabridge-free-cohort', false)
  } catch {
    ...
    <div>
      ...
      <div className="py-6">
        <div className="flex items-center gap-3 mb-4">
          <LiveBadge />
          <p className="text-gray-500 font-mono text-xs">Free Cohort — Live Slides</p>
        </div>
