...
export const metadata: Metadata = {
  title: 'Register | Metabridge Academy',
  description: 'Register for Metabridge Academy and start your digital skills journey.',
}

export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-cyber-bg flex items-center justify-center relative overflow-hidden px-4 py-10">
      {/* Dot grid */}
      <div
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-heading font-bold text-white mb-1">Join the Academy</h1>
          <p className="text-gray-400 text-sm font-mono">Fill the form to request access</p>
        </div>
