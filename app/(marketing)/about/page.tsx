              ...
              <FadeInSection key={member.name} delay={i * 150}>
                <div className="card h-full overflow-hidden">
                  ...
                  <div className="p-8">
                    ...
                    {member.name === 'Gideon Owhonda' && (
                      <div className="mt-5 pt-5 border-t border-gray-100">
                        <a
                          href="https://www.linkedin.com/in/gidotyo"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 bg-[#0A66C2] text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-[#0958a8] transition-colors"
                        >
